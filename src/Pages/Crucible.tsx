  ...
  return (
    <div>
      ...
      <p>
        ...
        mountain has been hollowed out by the dwarves. Human society throughout Crucible is very similar to Europe in the 1700s. 
        ...
        hamlets that provide for grain and produce to the local baron. A city-state’s power can wax or wane dramatically depending 
        on the ability of the local baron.
      </p>
      ...
      <p>
        I may add a second continent, in which case I'd probably want to change the name of the primary continent too. 😀
      </p>
      ...
      <p>
        I'm going for a pre-industrial vibe. Steam Engines exist, but they're mostly bespoke unreliable things. 
        NPCs that can cast magic are fairly common at low levels, but drop off at high levels. I'm not sure if there 
        is a single 20th level caster in the whole world.
      </p>
