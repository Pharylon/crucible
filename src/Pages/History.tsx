...
const History = () => {
    return (
        <div>
            ...
            <p>
                It was during this tumultuous time that the new religion of the <a href="./woldSmith">Worldsmith</a> took hold in Esa,
                supplementing the <a href="./oldWays">Old Ways</a>. It taught that there was only one true God, and that he was angry at
            ...
            <p>
                ...
                <a href="./woldSmith">Worldsmith</a> across Crucible. Whatever people they conquered, they took pains to assimilate them into
                ...
                Esatheans saw all races as able to worship the <a href="./woldSmith">Worldsmith</a>.
            </p>
